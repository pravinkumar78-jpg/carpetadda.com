          ...
          <div className="sticky top-24 space-y-4">
            <div className="card-premium p-6">
              ...
              <div className="grid grid-cols-2 gap-2 mt-3">
                ...
                <a href="https://wa.me/918828830707" target="_blank" rel="noopener" className="flex items-center justify-center gap-1.5 text-sm py-2.5 border border-emerald-200 bg-emerald-50 text-emerald-700 rounded-lg hover:bg-emerald-100 font-medium"><WhatsappLogo size={14} /> WhatsApp</a>
              </div>
