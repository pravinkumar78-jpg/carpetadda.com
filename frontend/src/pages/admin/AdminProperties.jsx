                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1.5 flex-wrap">
                      {r.status === "pending_review" && (
                        <>
                          <button data-testid={`approve-${r.id}`} onClick={() => review(r, "approve")} className="h-8 px-3 inline-flex items-center whitespace-nowrap text-xs font-semibold bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Approve</button>
                          <button data-testid={`reject-${r.id}`} onClick={() => review(r, "reject")} className="h-8 px-3 inline-flex items-center whitespace-nowrap text-xs font-semibold bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Reject</button>
                        </>
                      )}
