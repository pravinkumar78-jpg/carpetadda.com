...
function AdminPasswordChange() {
  const [f,setF]=useState({current_password:"",new_password:"",confirm_password:""}); const [busy,setBusy]=useState(false);
