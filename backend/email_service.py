...
def _build_html(lead: dict, kind: str, ctx: dict) -> str:
    ...
    rows = [
        ...
        _fmt_row("Property Finalised", ("Yes" if lead.get("property_finalised") else "No") if lead.get("property_finalised") is not None else None),
        _fmt_row("Property Cost", _fmt_budget(lead.get("property_cost"), None).replace("From ", "") if lead.get("property_cost") else None),
        _fmt_row("Loan Amount", _fmt_budget(lead.get("loan_amount"), None).replace("From ", "") if lead.get("loan_amount") else None),
